...
public class Gallery extends AdminBaseActivity{
	Button addImage;
	...
	set(navMenuTitles, navMenuIcons);
		dataList = (ListView) findViewById(R.id.list_image);
		/**
		 ...
		 */
		List<Image> contacts = db.getAllImages();
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case CAMERA_REQUEST:
			...
			if (extras != null) {
				...
				Log.e("output before conversio", imageInByte.toString());
				// Inserting Contacts
				Log.d("Insert: ", "Inserting ..");
				db.insertImage(new Image("Android", imageInByte));
				Intent i = new Intent(Gallery.this,
						Gallery.class);
				startActivity(i);
				finish();
