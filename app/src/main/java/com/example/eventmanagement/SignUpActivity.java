	...
	public class SignUpActivity extends Activity {
		...
		protected void onCreate(Bundle savedInstanceState) 
		{
			...
			editTextPhone.setCompoundDrawablesWithIntrinsicBounds(R.drawable.phone, 0, 0, 0);
		        ...
		        list.add("PE");
		        list.add("MCA");
		        dataAdapter = new ArrayAdapter<String>(SignUpActivity.this,android.R.layout.simple_list_item_1,list);
			...
			btnCreateAccount.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					{  
					  ...
					  SharedPreferences user=PreferenceManager.getDefaultSharedPreferences(SignUpActivity.this);
                      user.edit().putString("user_name", userName).commit();
                      SharedPreferences useremail=PreferenceManager.getDefaultSharedPreferences(SignUpActivity.this);
